...
namespace InventorySystem.Data
{
    public static class QueryableExtensions
    {
            ...
            where T : class
        {
            ...
            PaginatedList<T> paginatedList = new(items, count, pageIndex, pageSize);
            ...
            where T : class
        {
            ...
            PaginatedList<T> paginatedList = new(items, count, specification.PageIndex, specification.PageSize);
            return paginatedList;
        }
    }
}
